...
// // This is a custom Type TO Do List who have two fields ID and Task.
...
//     // Now write the task to the todo.txt
...
//     // If User wants to add more new task again then call the same function else return
//     if (ch == 'y')
//     {
//         addTask();
//     }
...
//         cout << "\n\tTask has been deleted successfully!" << endl;
//     }
//     else
//     {
//         cout << "\n\tTask has been cancelled successfully!" << endl;
//     }
// }
...
//         remove("todo.txt");
//         rename("temp.txt", "todo.txt");
//         cout << "\n\tTask has been updated successfully!" << endl;
//     }else{
//         cout << "\n\tTask has been cancelled successfully!" << endl;
//     }
// }
...
//     system("cls");
//     system("Color EO");
//     system("title todoapp @copyRitik");
//     cout << "\t\t\t***********************************************************************" << endl;
//     cout << "\t\t\t                       WELCOME TO Your ToDo List                       " << endl;
//     cout << "\t\t\t************************************************************************" << endl;
...
int main()
{
    ...
    system("title To-Do-App @copy Ritik");
    cout<<"\t\t\t***********************************************************************"<<endl;
    cout<<"\t\t\t*                                                                     *"<<endl;
	cout<<"\t\t\t*                      WELCOME TO Your ToDo List                      *"<<endl;
	cout<<"\t\t\t*                                                                     *"<<endl;
